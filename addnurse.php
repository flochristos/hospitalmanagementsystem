            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Add Nurse</h3>
                        <ol class="breadcrumb">
                ...
                if(isset($_POST['subbtn']))
                     {
                          ...
                          $sql ="INSERT INTO nurses(date, name, email, special_no, specialization, appointment, medi_licen, admin_cons)  VALUES(CURDATE(),'$fname', '$email', '$special_no', '$specialization', '$appointment', '$medi_licen', '$admin_cons')";
                          ...
                          if($db->query($sql)== TRUE){
                                           ...
                                           ?><div class="container"  id="validatn">
                                                <div class="alert alert-success alert-dismissible">
                                                  ...
                                                  <strong>Success!</strong> Nurse Added Successfully.
                                                </div> 
                                              </div>
                                              <?php
                          }else{
