...
$query2 = "SELECT * FROM `pharm` LIMIT $recordSkip, $recordperpage";
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0"> View Presciptions </h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                            <li class="breadcrumb-item active">Pharmacy</li>
                            <li class="breadcrumb-item active">View Presciptions </li>
                        </ol>
                    </div>
                   ...
                   <div class="">
                            <div class="card-body" style="padding: 5px;">
                                ...
                                <div class="d-md-flex align-items-center">
                                    <div>
                                        <h5 class="card-title">Filter Patient Prescription by ID </h5><hr>
                                ...
                                <table class="table v-middle" id="myTable">
                                    <thead>
                                        <tr class="bg-light" >
                                            ...
                                            <th class="border-top-0" style="text-align: center;">Order ID</th>
                                            <th class="border-top-0" style="text-align: center;">Patient_Name</th>
                                            <th class="border-top-0" style="text-align: center;">Drug_ Description</th>
                                    ...
                                    <tbody>
                                        <?php
                                             ...
                                             ?>
                                        <tr><small>
                                            <td><center><?php echo $nos++; ?> </center></td>
                                            <td><center><?php echo $r['orderid'] ?></center></td>
                                            <td><center><?php echo $r['pname'] ?></center></td>
                                            <td><center><?php echo $r['dnames'] ?></center></td>
                                            <td><center><?php echo $r['pdate'] ?></center></td>
                                            </small>
                                        </tr>
