...
<?php
 ...
 $coode = $_GET['ide'];
                   ...
                   // mysqli select query
                    $products = $db->query("SELECT name, email, special_no, specialization, appointment, medi_licen, admin_cons FROM doctors WHERE id='$coode'");
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="managedoctors.php">Manage Doctor</a></li>
                            <li class="breadcrumb-item active">View/Edit Doctor</li>
                        </ol>
                    </div>
            ...
            <section class="panel">
              <header class="panel-heading">
                ...
                <?php
                  ...
                  $sql = "UPDATE doctors SET name='$name', email='$email', special_no='$special_no', specialization='$specialization', appointment='$appointment', medi_licen='$medi_licen', admin_cons='$admin_cons' WHERE id='$coode'";
