...
$query2 = "SELECT * FROM `doctors` LIMIT $recordSkip, $recordperpage";
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0"> Manage Doctors </h3>
                        <ol class="breadcrumb">
                   ...
                   <div class="">
                            <div class="card-body" style="padding: 5px;">
                                ...
                                <div class="d-md-flex align-items-center">
                                    <div>
                                        <h5 class="card-title">Filter Doctor Name </h5><hr>
                                        <h5 class="card-subtitle"><!-- Search form -->
                                         ...
                                         <?php
                                          if (isset($_GET['deleteid'])){
                                            ...
                                            $sql = "DELETE FROM doctors WHERE id='$deleteid'";
                                                        ...
                                                        if ($conn->query($sql) === TRUE) {
                                                            ?><div class="container"  id="validatn">
                                                              ...
                                                              <meta http-equiv="refresh" content="1;url=managedoctors.php" />
                                                              <?php
                                                        } else {
                                                             ?><div class="container"  id="validatn">
                                                                <div class="alert alert-danger alert-dismissible">
                                                                  <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                                                  <strong>Error!</strong> Doctor Not Deleted!
                                                                </div> 
                                                              </div>
                                                              <?php
                                                        }
                                    ...
                                    <div class="ml-auto">
                                        <div class="dl">
                                            <h5 class="card-title">Search Doctor Name </h5><hr>
                                        <h5 class="card-subtitle"><!-- Search form -->
                                            <form class="form-inline md-form form-sm" action="doctorresult.php" method="get">
                                ...
                                <table class="table v-middle" id="myTable">
                                    <thead>
                                        <tr class="bg-light" >
                                            ...
                                            <th class="border-top-0" style="text-align: center;">Manage_Doctor</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="viewdoctors.php?ide=<?php echo ($idd); ?>" class="btn btn-primary " style="padding: 5px;color: white !important;" >View</a> 
                                            <a href="managedoctors.php?deleteid=<?php echo ($idd); ?>" class="btn btn-danger"  style="padding: 5px;color: white !important;" >Delete</a>
                                            </td>
                                        </tr>
