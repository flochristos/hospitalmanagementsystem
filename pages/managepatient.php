...
$query2 = "SELECT * FROM `patients` ORDER BY id DESC LIMIT $recordSkip, $recordperpage";
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0"> InPatient List </h3>
                        <ol class="breadcrumb">
                                ...
                                <table class="table v-middle" id="myTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $r['nhis_no'] ?></td>
                                            <td>
                                                <label class="label label-danger"><?php echo $r['diagnosis'] ?></label>
                                            </td>
                                            <td><?php echo $r['treatment'] ?></td>
                                            <td><?php echo $r['admission'] ?></td>
